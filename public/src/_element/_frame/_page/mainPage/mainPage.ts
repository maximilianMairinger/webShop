...
export default class Main extends Page {
  ...
  private panelName: "overview" | "monday" | "tuesday" | "wednesday" | "thursday" | "friday" | "langauge" | "theme" | "sign_out" | "feedback";
  ...
  constructor(panelName: "overview" | "monday" | "tuesday" | "wednesday" | "thursday" | "friday" | "langauge" | "theme" | "sign_out" | "feedback" = "overview") {
    super();

    this.overlay = ce("main-page-overlay");
    this.navOpenSelector = ce("main-page-nav-open-selector");

    this.nav = new Nav((panelName: "overview" | "monday" | "tuesday" | "wednesday" | "thursday" | "friday" | "langauge" | "theme" | "sign_out" | "feedback") => {
    ...
    getAllDayNames((...dayNames: string[]) => {
  ...
  public async setPanel(panelName: "overview" | "monday" | "tuesday" | "wednesday" | "thursday" | "friday" | "langauge" | "theme" | "sign_out" | "feedback") {
    this.panelName = panelName;
    await this.panelManager.setPanel(panelName);
    this.nav.activateOption(panelName);
  }
  public get panel(): "overview" | "monday" | "tuesday" | "wednesday" | "thursday" | "friday" | "langauge" | "theme" | "sign_out" | "feedback" {
